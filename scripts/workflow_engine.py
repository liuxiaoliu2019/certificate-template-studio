...
TEXTBOOK_TRANSITIONS = {
    ...
    "generating_portrait": {"validating_portrait", "blocked"},
    "validating_portrait": {"awaiting_portrait_approval", "generating_portrait", "blocked"},
    "awaiting_portrait_approval": {"revising_portrait", "complete", "blocked"},
...
TEMPLATE_TRANSITIONS = {
    ...
    "deriving_opposite": {"validating_opposite", "blocked"},
    "validating_opposite": {"awaiting_opposite_approval", "deriving_opposite", "blocked"},
    "awaiting_opposite_approval": {"revising_opposite", "complete", "blocked"},
